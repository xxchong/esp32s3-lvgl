...
static void screen_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        case LV_DIR_LEFT:
        {
            ...
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_1, guider_ui.screen_1_del, &guider_ui.screen_del, setup_scr_screen_1, LV_SCR_LOAD_ANIM_OVER_RIGHT, 200, 200, false, true);
            break;
        }
        default:
            break;
...
static void screen_btn_1_event_handler (lv_event_t *e)
{
    ...
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.screen_1, guider_ui.screen_1_del, &guider_ui.screen_del, setup_scr_screen_1, LV_SCR_LOAD_ANIM_MOVE_LEFT, 200, 200, true, true);
        break;
    }
    default:
        break;
...
static void screen_1_btn_1_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.screen, guider_ui.screen_del, &guider_ui.screen_1_del, setup_scr_screen, LV_SCR_LOAD_ANIM_OVER_RIGHT, 200, 200, true, true);
        break;
    }
    default:
        break;
