...
#define APP_SYMBOL USER_SYMBOL_GAME2, USER_SYMBOL_SETTING, USER_SYMBOL_COM1, USER_SYMBOL_MUSIC2, USER_SYMBOL_TOOLS, USER_SYMBOL_CALENDAR, USER_SYMBOL_MQTT, USER_SYMBOL_BLUETOOTH1, USER_SYMBOL_WEATHER, USER_SYMBOL_MUSIC1
